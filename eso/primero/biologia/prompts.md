...
# Prompts de la asignatura Biología y Geología de 1º de la ESO![Logo](../../../logo.png)
</div>

## Contenido
- [Prompt 01 - Examen de Biología y Geología](#prompt01)
- [Prompt 02 - Explicar la fotosíntesis con un símil](#prompt02)

## Prompts
## <a name="prompt01"></a> Prompt 01 - Examen de Biología y Geología
```
Actúa como si fueras un examen de Biología y Geología de 1º de la ESO en el sistema educativo español.
...
## <a name="prompt02"></a> Prompt 02 - Explicar la fotosíntesis con un símil
```
Actúa como un profesor de biología de secundaria.
Explica el proceso de la fotosíntesis de las plantas usando un símil con una fábrica.
Cada parte del proceso debe compararse con una parte de la fábrica (entrada de materia prima, procesado, producto final, residuos).
