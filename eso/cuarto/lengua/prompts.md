...
# Prompts de la asignatura Lengua Castellana y Literatura de 4º de la ESO![Logo](../../../logo.png)
</div>

## Contenido
- [Prompt 01 - Examen de Lengua](#prompt01)
- [Prompt 02 - Corrección y mejora de redacción](#prompt02)

## Prompts
## <a name="prompt01"></a> Prompt 01 - Examen de Lengua
```
Actúa como si fueras un examen de Lengua Castellana y Literatura de 4º de la ESO en el sistema educativo español.
...
## <a name="prompt02"></a> Prompt 02 - Corrección y mejora de redacción
```
Actúa como un profesor de lengua de secundaria.
Te voy a dar un texto que he escrito. Quiero que me lo corrijas señalando:
1. Errores ortográficos y gramaticales.
2. Problemas de cohesión y coherencia.
3. Propuestas de mejora del vocabulario (sinónimos, expresiones más formales).

No me reescribas el texto entero. Señálame los errores y dame pistas para que yo mismo lo mejore.
Al final, dime 3 consejos personalizados para mejorar mi expresión escrita.
```
