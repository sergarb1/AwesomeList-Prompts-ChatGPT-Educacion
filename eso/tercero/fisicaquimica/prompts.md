...
# Prompts de la asignatura Física y Química de 3º de la ESO![Logo](../../../logo.png)
</div>

## Contenido
- [Prompt 01 - Examen de Física y Química](#prompt01)
- [Prompt 02 - Problemas de cinemática guiados](#prompt02)

## Prompts
## <a name="prompt01"></a> Prompt 01 - Examen de Física y Química
```
Actúa como si fueras un examen de Física y Química de 3º de la ESO en el sistema educativo español.
...
## <a name="prompt02"></a> Prompt 02 - Problemas de cinemática guiados
```
Actúa como un profesor de física de secundaria.
Voy a practicar problemas de cinemática (MRU y MRUA). Propónme un problema de movimiento rectilíneo y guíame paso a paso para resolverlo.

No me des la solución completa de golpe. Dame los datos, pregúntame qué fórmula usar, y espera mi respuesta antes de continuar.
Si me equivoco, corrígeme con una explicación sencilla.

Cuando termine un problema, pregúntame si quiero otro o si quiero repasar algún concepto.
```
